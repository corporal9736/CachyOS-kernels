...
detect_version
# COMMIT of CachyOS/linux-cachyos: 70f7e53e2c6bedfcbec9ac29402e94ef19abb444
# This is the commit hash for Cachyos/kernel-patches
EGIT_COMMIT="2cc5d2032d9bac86a07d68995c8e4340f5a81572"
...
src_prepare() {
	...
	use bore && scripts/config -e SCHED_BORE --set-val MIN_BASE_SLICE_NS 1000000
	...
	use rt-bore && scripts/config -e SCHED_BORE \
		--set-val MIN_BASE_SLICE_NS 1000000 -e PREEMPT_COUNT -e PREEMPTION \
		-d PREEMPT_VOLUNTARY -d PREEMPT -d PREEMPT_NONE -d PREEMPT_RT \
		-d PREEMPT_DYNAMIC -e PREEMPT_BUILD -e PREEMPT_BUILD_AUTO \
		-e PREEMPT_AUTO
	use sched-ext && scripts/config -e SCHED_CLASS_EXT -e SCHED_BORE \
		--set-val MIN_BASE_SLICE_NS 1000000
