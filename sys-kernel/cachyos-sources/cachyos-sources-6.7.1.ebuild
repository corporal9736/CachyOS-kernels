...
detect_version
# COMMIT of CachyOS/linux-cachyos: 1bfdfc772536db752e04cd9393e80d6f97012125
# This is the commit hash for Cachyos/kernel-patches
EGIT_COMMIT="93345c020edf4932e10aa035781b2f9dc386af1f"
...
LICENSE="GPL-3"
KEYWORDS="~amd64"
IUSE="+bore-sched-ext eevdf bore rt-eevdf rt-bore sched-ext +lrng"
REQUIRED_USE="^^ ( bore-sched-ext eevdf bore rt-eevdf rt-bore sched-ext )"
...
src_prepare() {
	...
	eapply "${PATCH_DIR}/misc/0001-Add-extra-GCC-optimization-flags.patch"
	...
	# Set cpu scheduler
	use bore-sched-ext && scripts/config -e SCHED_BORE -e SCHED_CLASS_EXT
	...
	(use eevdf || use bore-sched-ext || use bore || use sched-ext) &&
	...
	# Disable debug for sched-ext and bore-sched-ext
	(!( use sched-ext || use bore-sched-ext)) && echo ">>> debug info disabled"
	(!( use sched-ext || use bore-sched-ext)) && scripts/config -d DEBUG_INFO \
		-d DEBUG_INFO_BTF \
		-d DEBUG_INFO_DWARF4 \
		-d DEBUG_INFO_DWARF5 \
