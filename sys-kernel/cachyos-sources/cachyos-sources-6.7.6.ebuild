...
detect_version
# COMMIT of CachyOS/linux-cachyos: 2833d798a4b07b9163d610fda56f370e0e3fb97b
# This is the commit hash for Cachyos/kernel-patches
EGIT_COMMIT="10ed86207d93c531b8d720356907f027352287c3"
...
LICENSE="GPL-3"
KEYWORDS="~amd64"
IUSE="+bore-sched-ext eevdf bore rt-eevdf rt-bore sched-ext"
...
src_prepare() {
	...
	if use bore-sched-ext; then
		...
		eaaply "${PATCH_DIR}/sched/0001-bore-cachy.patch"
