...
detect_version
# COMMIT of CachyOS/linux-cachyos: "8a63eb57721d23a2c062fa4e75ceac74eab001ab"
# This is the commit hash for Cachyos/kernel-patches
EGIT_COMMIT="d8cd6762c0b3329164d15bb1223df8a9abcfc40b"
...
src_prepare() {
	...
	if use rt-eevdf; then
		eapply "${PATCH_DIR}/misc/0001-rt-i915.patch"
