...
detect_version
# COMMIT of CachyOS/linux-cachyos: edcb942118dd7702d8be5eaa8f53b20085560620
EGIT_COMMIT="6605eeeea6b6abd96b07d4bbbce4cc84e6397ab2"
...
LICENSE="GPL-3"
KEYWORDS="~amd64"
IUSE="+bore-eevdf eevdf pds bmq tt bore cfs cfs-rt bore-hardened +bcachefs +lrng"
...
src_prepare() {
	...
	if use eevdf; then
		eapply "${PATCH_DIR}/sched/0001-EEVDF-cachy.patch"
		eapply "${PATCH_DIR}/misc/0001-eevdf-Disable-DELAY_DEQUEUE.patch"
