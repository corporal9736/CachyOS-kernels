...
detect_version
# COMMIT of CachyOS/linux-cachyos: e16a08e24d19806b2ca42cfd93e10caa21ce3ee0
# This is the commit hash for Cachyos/kernel-patches
EGIT_COMMIT="8b0b1cea70459b42245fb428d020d748f2a05dd0"
...
LICENSE="GPL-3"
KEYWORDS="~amd64"
IUSE="+bore-eevdf eevdf bore rt-eevdf rt-bore sched-ext"
...
src_prepare() {
	...
	# lrng patch is currently not available for 6.7.0
	# 	 if use lrng; then
	...
	# Set cpu scheduler
	(use bore-eevdf || use bore) && scripts/config -e SCHED_BORE
	...
	# Disable debug
	(! use sched-ext) && scripts/config -d DEBUG_INFO \
		-d DEBUG_INFO_BTF \
		-d DEBUG_INFO_DWARF4 \
		-d DEBUG_INFO_DWARF5 \
